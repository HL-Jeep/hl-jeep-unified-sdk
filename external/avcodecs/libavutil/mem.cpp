...
static std::atomic_size_t max_alloc_size = INT_MAX;

void av_max_alloc(size_t max){
	atomic_store_explicit(&max_alloc_size, max, std::memory_order_relaxed);
}
...
void *av_malloc(size_t size)
{
    ...
    if (size > atomic_load_explicit(&max_alloc_size, std::memory_order_relaxed))
        return NULL;
...
void *av_fast_realloc(void *ptr, unsigned int *size, size_t min_size)
{
    ...
    max_size = atomic_load_explicit(&max_alloc_size, std::memory_order_relaxed);
